package com.test.hackerrank.reverselinkedlist;
...
class Result {
    ...
    public static SinglyLinkedListNode reverse(SinglyLinkedListNode node) {
        ...
        values.forEach(singlyLinkedList::insertNode);
        return singlyLinkedList.head;
    }

    private static void collect(ArrayList<Integer> values, SinglyLinkedListNode node) {
        if (node != null) {
